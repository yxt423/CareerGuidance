...
public class UserDataSource
{
    ...
    private String[] allColumns = { SQLiteHelperClass.COLUMN_ID[1],
    ...
    public Student createStudent(String fName, String lName, String gndr, Date dob, String location, String username, String password)
    {
        ...
        values.put(SQLiteHelperClass.COLUMN_USER4[0], dob);
        ...
        Cursor cursor = database.query(SQLiteHelperClass.TABLE_USER,
                allColumns, SQLiteHelperClass.COLUMN_ID + " = " + insertId, null,
                null, null, null);
    ...
    public void deleteStudent(User user)
    {
        ...
        database.delete(SQLiteHelperClass.TABLE_USER, SQLiteHelperClass.COLUMN_ID
                + " = " + id, null);
    }
    ...
    public List<User> getAllUsers()
    {
        ...
        {
            User user = cursorToStudent(cursor);
            students.add(user);
            cursor.moveToNext();
        }
    ...
    private User cursorToStudent(Cursor cursor) {
        User user = new User();
        ...
        user.setLocation(cursor.getInt(5));
